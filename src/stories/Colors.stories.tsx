...
export const Functional: Story = {
  args: {
    swatch: Object.entries(fullConfig.theme.colors)
      ...
      .sort(([a], [b]) => functionalSwatch.indexOf(a as ColorKey) - functionalSwatch.indexOf(b as ColorKey))
      .map(([name, colors]) => {
        return {
          name,
          colors: (typeof colors === 'string' ? {[name]: colors} : colors) as Record<string, string>,
        }
      }),
  },
}
